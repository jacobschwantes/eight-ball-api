    ...
    <div className="bg-black min-h-screen w-screen overflow-x-hidden flex   justify-center  lg:p-10 py-4 px-1">
      <div className="lg:max-w-5xl w-full flex-grow flex flex-col">
        <div className="flex flex-col items-center">
          <h1 className="text-white font-bold text-5xl">Magic 8 Ball</h1>
        ...
        <div className="w-full bg-gray-700 rounded-lg flex items-center">
          <a
            href="https://magic-eight-ball-api.herokuapp.com/api/v1"
            className="text-white text-2xl p-4"
          >
            https://magic-eight-ball-api.herokuapp.com/api/v1
          </a>
        </div>
        ...
        <div className="w-full bg-gray-700 rounded-lg  flex items-center ">
          <a
            ...
            className="text-white text-2xl p-4"
          >
            https://magic-eight-ball-api.herokuapp.com/api/v1/biased?q=(yourquestion)
          </a>
        </div>
        <h1 className="text-white ">
          ...
          must add a <span className="italic">q</span> paramenter to your
          request to attach your question otherwise the response will always be
          neutral.
        </h1>
        <h1 className="text-white text-xl mt-4">Example response:</h1>
        <div className="w-full bg-gray-700 rounded-lg flex items-center">
        ...
        </div> <footer className=" mt-5 flex justify-between">
        
      <a href className="dark:text-white text-white transition-colors" target="_blank" rel="noreferrer" href="https://github.com/j-sch23/magic-eight-ball-api">
